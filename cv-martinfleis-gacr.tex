...
\titlespacing{\section}{0pt}{16pt plus 4pt minus 4pt}{6pt plus 2pt minus 2pt}
...
\begin{document}
    ...
    19 papers indexed in Web of Science, 2 papers in other peer-reviewed journals, 5 policy reports \\
    Web of Science: 580 citations, H-index: 10, Google Scholar: 1675 citations, H-index: 14

    \subsection*{Selected publications not included in Bibliography}
