...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2020] \tab{}\textit{NumFOCUS} - "Improvement and modernization of GeoPandas documentation", \$5,000
    ...
    \begin{itemize}
        ...
        \item[2021] \tab{}Mentor, Google Summer of Code. Project: \textit{Geopandas - Dask bridge to scale geospatial analysis}, Student: Thomas Statham (University of Bristol)
