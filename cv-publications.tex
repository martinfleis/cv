...
\begin{document}
    ...
    21 publications in journals with impact factor as of 31/3/2026.

    \subsection*{Journal Articles}

    \begin{tablist}

        \item[2026] \tab{}Fleischmann, M., Samardzhiev, K., Brázdová, A., Dančejová, D., and Winkler, L., \enquote{The Hierarchical Morphotope Classification: A Theory-Driven Framework for Large-Scale Analysis of Built Form} \textit{Cities} (accepted)
